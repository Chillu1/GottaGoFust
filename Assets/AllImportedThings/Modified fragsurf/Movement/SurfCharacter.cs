...
namespace Fragsurf.Movement
{
    ...
    public class SurfCharacter : MonoBehaviour, ISurfControllable
    {
        ...
        public static string TempVelocityText;
        ...
        private bool allowCrouch = true; // This is separate because you shouldn't be able to toggle crouching on and off during gameplay for various reasons
        ...
        private void Update()
        {
            ...
            if (numberOfTriggers != triggers.Count)
            {
                ...
                foreach (Collider trigger in triggers)
                {
                    ...
                    if (trigger.GetComponentInParent<WaterSu>())
                        underwater = true;
                }
            }
            ...
            VelocityText.text = "Velocity: " + _controller.speed.ToString("F2");
        }
