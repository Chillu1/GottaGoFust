...
public class Movement : MonoBehaviour
{
    ...
    */
    ...
    private float duckTime;// /Unduck time

    public float gravity;

    //*/

    private Vector3 desiredMove;//AcellDir
    ...
    private void InputGotten()
    {
    }

    private void Gravity()//Member this is code gravity/friction, not Rigidbody
    {
    }

    private RaycastHit hitBot;//Bottom
    private RaycastHit hitMid;//Middle
    private RaycastHit hitTop;//Top
